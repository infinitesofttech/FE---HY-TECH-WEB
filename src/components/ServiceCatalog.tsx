    ...
    <section id="services" className="py-20 bg-slate-50 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-3">
          <div className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-indigo-50 text-[#4F46E5] text-xs font-extrabold uppercase tracking-wider border border-indigo-200">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-4 mb-10 scrollbar-none">
          ...
          {SERVICES_DATA.map((cat) => {
            ...
            return (
              ...
              >
                <CatIcon className="w-3.5 h-3.5 text-[#4F46E5]" />
        ...
        {filteredCategories.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-[32px] border border-slate-200 p-8 shadow-sm">
            <FileSearch className="w-12 h-12 text-[#4F46E5] mx-auto mb-3" />
              ...
              return (
                <div key={category.id} className="space-y-6">
                  ...
                  <div className="flex items-center gap-3 border-b border-slate-200 pb-3">
                    <div className="p-2.5 rounded-full bg-indigo-50 border border-indigo-200 text-[#4F46E5]">
                    ...
                    {category.items.map((item, idx) => {
                      ...
                      return (
                        ...
                        >
                          {/* Item Badge */}
                          {item.badgeEn && (
                            <span className="absolute top-5 right-5 text-[10px] font-extrabold bg-indigo-50 text-[#4F46E5] px-3 py-1 rounded-full border border-indigo-200">
                              {item.badgeEn}
                            </span>
                          )}
                          ...
                          <div className="space-y-4">
                            {/* Icon Container */}
                            <div className="w-13 h-13 rounded-2xl bg-indigo-50 border border-indigo-100 text-[#4F46E5] flex items-center justify-center group-hover:bg-[#4F46E5] group-hover:text-white transition-all duration-300">
                              <ItemIcon className="w-6 h-6" />
                            </div>

                            <div>
                              <h4 className="text-base font-extrabold text-[#1E1B4B] group-hover:text-[#4F46E5] transition-colors">
                                {item.titleEn}
                              </h4>
                          ...
                          <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between text-xs font-extrabold text-[#4F46E5]">
      ...
      {/* Detail Modal */}
      {selectedService && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#1E1B4B]/70 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-[32px] max-w-lg w-full p-6 sm:p-8 shadow-2xl relative border border-slate-200 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <div className="p-3 bg-indigo-50 text-[#4F46E5] border border-indigo-200 rounded-full">
                ...
                <div>
                  ...
                  <span className="text-xs text-[#4F46E5] font-extrabold">HY-TECH Dharampur Service</span>
                </div>
              </div>
              ...
              {selectedService.requiredDocsEn && (
                <div className="space-y-2">
                  <h4 className="text-xs font-extrabold text-[#1E1B4B] uppercase tracking-wider flex items-center gap-1.5">
              ...
              <div className="space-y-2 pt-2">
                <a
                  ...
                  className="w-full py-4 bg-[#4F46E5] hover:bg-[#4338CA] text-white font-extrabold rounded-full shadow-md text-xs flex items-center justify-center gap-2 transition-all"
                >
